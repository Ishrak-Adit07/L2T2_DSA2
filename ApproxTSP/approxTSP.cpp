...
public:
    ...
    vector<int> preorderTraversalOfMST(){
...
int main(void){
    ...
    vector<int> exactTSPlengths;
    vector<int> approxTSPlengths;
    ...
    for(int testCase=0; testCase<X; testCase++){
        ...
        exactTSPlengths.push_back(exactTspLength);
        approxTSPlengths.push_back(approxTspLength);
